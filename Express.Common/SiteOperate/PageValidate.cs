...
namespace Express.Common.SiteOperate
{
	/// <summary>
	/// 页面数据校验类
    /// Copyright (C) DocViewer 2004-2012
	/// </summary>
	public class PageValidate
	{
        private static Regex RegPhone = new Regex("^[0-9]+[-]?[0-9]+[-]?[0-9]$");
        private static Regex RegCellphone = new Regex("0?(13|14|15|18)[0-9]{9}");
        ...
        public static bool IsCellPhone(string inputData)
        {
            Match m = RegCellphone.Match(inputData);
            return m.Success;
        }
        /// <summary>
